...
export function StudyIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      {/* Desk */}
      <rect x="80" y="280" width="340" height="12" rx="6" fill="#c4b5fd" />
      <rect x="120" y="292" width="12" height="60" rx="4" fill="#a78bfa" />
      ...
      <rect
        ...
        fill="#ddd6fe" transform="rotate(-5 365 259)"
      />
      <rect
        x="345" y="242" width="50" height="38" rx="4"
        fill="#c4b5fd" transform="rotate(3 370 261)"
      />
      {/* "ABC" on flashcard */}
      <text
        x="370" y="267" textAnchor="middle"
        fontSize="13" fontWeight="bold" fill="#6d28d9"
      ...
      {/* Chat bubble — "Hola" */}
      <g opacity="0.8">
        <rect x="385" y="42" width="56" height="30" rx="12" fill="#c4b5fd" />
        <polygon points="400,72 406,72 398,80" fill="#c4b5fd" />
        <text x="413" y="62" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#4c1d95">Hola</text>
      </g>
      ...
      <circle cx="400" cy="120" r="3" fill="#a78bfa" opacity="0.6" />
      <circle cx="370" cy="150" r="5" fill="#f0abfc" opacity="0.5" />
